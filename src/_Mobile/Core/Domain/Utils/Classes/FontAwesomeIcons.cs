namespace FluxoDeCaixa.Mobile.Core.Domain.Utils.Classes;
...
public static class FontAwesomeIcons
{
    ...
    public static string FAGripDotsVertical = "\uf58e";
    public static string FATress = "\f724";
    public static string FACalculator = "\f1ec";
